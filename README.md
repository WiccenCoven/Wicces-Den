Wicce's Den is a fork of [Monolith](https://github.com/Monolith-Station/Monolith) which is a fork of [Frontier](https://github.com/new-frontiers-14/frontier-station-14) that runs on the [Robust Toolbox](https://github.com/space-wizards/RobustToolbox) engine written in C#.
